...
export default function Footer() {
  ...
  useEffect(() => {
    const update = () => {
      ...
      setNomiFontSize(w < 640 ? w * 0.32 : w * 0.2)
    }
    update()
  ...
  if (isMobile) {
    return (
      <div style={{ width: '100%', padding: '48px 20px 32px', display: 'flex', flexDirection: 'column', gap: '40px' }}>
        {/* NOMI particle */}
        <div
          ref={nomiRef}
          style={{ height: `${nomiFontSize * 0.85}px`, width: `${nomiFontSize * 2.6}px` }}
        >
          {nomiFontSize > 0 && (
            <TextParticle
              text="NOMI"
